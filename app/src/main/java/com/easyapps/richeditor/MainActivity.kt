...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val html = "<html>\n" +
                ...
                "    <p><span style=\"color:#000000;\"><span>Colored text like </span></span><span style=\"color:#FF0000;\"><span style=\"font-size:18px\";>red </span></span><span style=\"color:#FFEB3B;\"><span style=\"font-size:18px\";>yellow </span></span><span style=\"font-size:18px\";><span style=\"color:#03A9F4;\">...</span></span></p>\n" +
                "    <br>\n" +
                "    </body>\n" +
                "    </html>"
